...
if($wynik = zapytanieDoBazy($mojePolaczenie, $query)){
                ...
                echo "Dodawanie do apteczki";
                echo "</div>";
                include "forms/frmWyszukajWSlowniku2.php";
                include "inc/naglTabApteczkaDodaj.php";
                while($wiersz = $wynik->fetch_assoc())
                    printf("<tr><td> %d </td><td> %s </td><td> %s </td><td> %s </td><td><a href=\"dodajdoapteczki2.php?id=%d\"> Dodaj do apteczki </a></td></tr>", $wiersz['id'], $wiersz['NazwaHandlowa'], $wiersz['Postac'], $wiersz['KodKreskowy'], $wiersz['id']);
                echo "</tbody></table>";
