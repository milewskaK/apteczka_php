...
if($wynik = zapytanieDoBazy($mojePolaczenie, sprintf($ApteczkaDoUtylizacji, $_GET['id_leku']))){
      
}else
    echo $txtBladZapytania;

//echo sprintf($ApteczkaDodajZListy, $_GET['id']);
if($wynik = zapytanieDoBazy($mojePolaczenie, sprintf($ApteczkaUsun, $_GET['id_leku']))){
    echo "<div class=\"alert alert-primary\" role=\"alert\">";
    echo "Usunięto rekord " . $_GET['id_leku'] . " z apteczki i przeniesiono go do utylizacji, cofnij się do strony głównej";
    echo "</div>";
    echo "</tbody></table>";     
    
    echo '<a href="gra.php?operacja=301"><font color="#123A61">Powrót do apteczki</a></font>';
}else
    echo $txtBladZapytania;
?>
